...
<div class="sub-area bg-color balance-area">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <h3 class="headline"><span class="title-head">B</span>alance</h3>
            ...
            <div class="sub-text ">	
                <div class="panel">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <h4>Balance</h4>
                        -->
                        <div class="balance" style="overflow-x:auto;">
                            <table id="balance_table" class="table">
                                <thead>
                                    <tr>
                                        <th class="col-md-3 col-xs-3">BALANCE</th>
                                        <th class="col-md-3 col-xs-4">AMOUNT</th>
                                        <th class="col-md-3 col-xs-2">DEPOSIT</th>
                                        <th class="col-md-3 col-xs-3">WITHDRAWAL</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="show_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/btc.png')}}" alt="" class="hidden-sm  hidden-xs">Bitcoin</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_eth" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/eth.png')}}" alt="" class="hidden-sm  hidden-xs">Ethereum</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_ltc" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/ltc.png')}}" alt="" class="hidden-sm  hidden-xs">Litecoin</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_bch" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/bch.png')}}" alt="" class="hidden-sm  hidden-xs">BitcoinCash</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_etc" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/etc.png')}}" alt="" class="hidden-sm  hidden-xs">Ethereum Classic</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_dash" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/dash.png')}}" alt="" class="hidden-sm  hidden-xs">Dash</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_btg" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/btg.png')}}" alt="" class="hidden-sm  hidden-xs">Bitcoin Gold</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_qtum" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/qtum.png')}}" alt="" class="hidden-sm  hidden-xs">Qtum</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                    </tr>
                                    <tr id="row_steem" class="hide_currency">
                                        <td>
                                            <span class="balance-image"><img src="{{URL::asset('images/currency/steem.png')}}" alt="" class="hidden-sm  hidden-xs">Steem</span> 
                                        </td>
                                        <td class="balance_amount">0.00</td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalDeposit" rel="nofollow" class="btn depositBtn">Deposit</a></td>
                                        <td class="balance_btn"><a href="#" role="button" data-toggle="modal" data-target="#modalWithdraw" rel="nofollow" class="btn withdrawBtn">Withdrawal</a></td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <div id="addCurrency">
                                                <a class="add-currency-btn"><span class="btn add-currency-icon"><i class="fa fa-plus"></i></span>  Add Currency</a>								                   
                                            </div>
                                        </td>
                                        <td colspan="3" class="add_currency_img">
                                            <a id="btc_icon" class="disabled"><img src="{{URL::asset('images/currency/btc.png')}}" alt="BTC" title="BTC"></a>
                                            <a id="eth_icon" onclick="add_currency('#row_eth','#eth_icon')"><img src="{{URL::asset('images/currency/eth.png')}}" alt="ETH" title="ETH"></a>												
                                            <a id="bch_icon" onclick="add_currency('#row_bch','#bch_icon')"><img src="{{URL::asset('images/currency/bch.png')}}" alt="BCH" title="BCH"></a>
                                            <a id="ltc_icon" onclick="add_currency('#row_ltc','#ltc_icon')"><img src="{{URL::asset('images/currency/ltc.png')}}" alt="LTC" title="LTC"></a>
                                            <a id="etc_icon" onclick="add_currency('#row_etc','#etc_icon')"><img src="{{URL::asset('images/currency/etc.png')}}" alt="ETC" title="ETC"></a>
                                            <a id="dash_icon" onclick="add_currency('#row_dash','#dash_icon')"><img src="{{URL::asset('images/currency/dash.png')}}" alt="DASH" title="DASH"></a>
                                            <a id="btg_icon" onclick="add_currency('#row_btg','#btg_icon')"><img src="{{URL::asset('images/currency/btg.png')}}" alt="BTG" title="BTG"></a>
                                            <a id="qtum_icon" onclick="add_currency('#row_qtum','#qtum_icon')"><img src="{{URL::asset('images/currency/qtum.png')}}" alt="QTUM" title="QTUM"></a>
                                            <a id="steem_icon" onclick="add_currency('#row_steem','#steem_icon')"><img src="{{URL::asset('images/currency/steem.png')}}" alt="STEEM" title="STEEM"></a>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
